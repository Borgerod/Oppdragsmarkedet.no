<!-- > better IOS Liquid glass test  -->

<div class="left">
	<div class="glassContainer dropdown-style white dark">
		<span class="material-symbols-outlined"> 1k </span>
		<span class="material-icons-outlined"> favorite </span>
		<span>Some Message</span>
	</div>
</div>
<div class="center">
	<div class="glassContainer dropdown-style grey white">
		<span class="material-symbols-outlined"> 1k </span>
		<span class="material-icons-outlined"> favorite </span>
		<span>Some Message</span>
	</div>
...
<div class="right">
	<div class="glassContainer dropdown-style black dark">
		<span class="material-symbols-outlined"> 1k </span>
		<span class="material-icons-outlined"> favorite </span>
		<span>Some Message</span>
	</div>
...
<!-- <div class="comp-row">
	<div class="glassContainer dropdown-style">
		<span class="material-symbols-outlined"> 1k </span>
		<span class="material-icons-outlined"> favorite </span>
		<span>Some Message</span>
	</div>
	<div class="glassContainer dropdown-style white">
		<span class="material-symbols-outlined"> 1k </span>
		<span class="material-icons-outlined"> favorite </span>
		<span>Some Message</span>
	</div>
	<div class="glassContainer dropdown-style grey dark">
		<span class="material-symbols-outlined"> 1k </span>
		<span class="material-icons-outlined"> favorite </span>
		<span>Some Message</span>
	</div>
...
<style>
	...
	.glassContainer.white::before {
		background-color: rgba(255, 255, 255, 0.3);
	}
	.glassContainer.grey::before {
		background-color: rgba(95, 95, 95, 0.3);
		background-color: rgba(66, 60, 90, 0.35);
	}
	.glassContainer.black::before {
		background-color: rgba(0, 0, 0, 0.3);
		background-color: rgba(19, 13, 13, 0.35);
	}
	.white span {
	...
	:global(.content) {
		...
		background: url(/images/fav/bathroom-renovation-1568x882.jpg) center center;
		background-image: url(/images/oIpwxeeSPy1cnwYpqJ1w_Dufer.jpg);
		background-image: url(/images/fav/medium-shot-man-working-with-helmet_23-2149343698.jpg);
		align-items: flex-start;
		background-image: url(/images/fav/photo-1489514354504-1653aa90e34e.avif);
	...
	.glassContainer::before {
		...
		box-shadow: inset 2px 2px 0px -2px rgba(255, 255, 255, 0.759);
		...
		-webkit-box-shadow:
			...
			inset 0 0 3px 1px rgba(255, 255, 255, 0.7);
		box-shadow:
			/* inset 2px 2px 2px -3px rgba(255, 255, 255, 1.752), */
			/* inset -2px -2px 3px -1px rgba(255, 255, 255, 0.452), */
				/* inset 0 0 3px 1px rgba(255, 255, 255, 0.458),
			inset 0 0 3px 1px rgba(156, 156, 156, 0.467),
			inset 0 0 3px 2px rgba(0, 0, 0, 0.2), */ 0
			10px 15px rgb(0 0 0 / 20%);
		/* box-shadow: inset -2px -2px 0px -2px rgba(255, 255, 255, 1.452); */
		/*  */
		background-color: rgba(255, 255, 255, 0.3);
		background-color: rgba(95, 95, 95, 0.3);
		background-color: rgba(0, 0, 0, 0.3);
	...
	.glassContainer::after {
		...
		overflow: hidden;
		isolation: isolate;
		/* backdrop-filter: blur(15px) brightness(1.3) saturate(0.9) contrast(0.8);
		backdrop-filter: blur(15px) brightness(0.8); */
		/* backdrop-filter: blur(20px) brightness(1.3) saturate(0.9) contrast(0.8);
