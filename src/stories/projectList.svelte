...
<script>
	...
	const demo_project = {
		...
		small_description:
			'Du har bachelorgrad eller mastergrad i regnskap og revisjon, og er gjerne statsautorisert revisor. Annen økonomiutdanning på mastergradsnivå kan også være aktuelt. Søkere med utdanning tatt i utlandet må vedlegge dokumentasjon fra HK-dir/NOKUT som bekrefter utdanningens omfang og nivå sammenlignet med tilsvarende norsk utdanning.',
		description:
			'Som et resultat av ny teknologi er revisjon i stor endring. Riksrevisjonen har utviklet egne dataanalyser og vil fortsette å ta i bruk mulighetene som den nye teknologien gir oss. Du får muligheten til å jobbe tett med kolleger i grenseflaten mellom teknologi og revisjon.Vi legger vekt på kompetanseutvikling og har gode stipendordninger for etter- og videreutdanning. Du får tilbud om medlemskap i revisorforeningens kurspakke, Rekomp. Hvis du ønsker å bli statsautorisert revisor kan du opptjene den nødvendige veiledede praksis hos oss. Vi har fleksitid og sommertid, og hver uke får du en time til å trene i arbeidstiden. Du blir medlem i Statens pensjonskasse som innebærer en god tjenestepensjon, yrkesskade- og gruppelivsforsikring og mulighet for gunstig boliglån.Du vil bli ansatt som rådgiver med lønnsspenn fra 590.000 kroner til 650.000 kroner, eller som seniorrådgiver med lønnsspenn fra 650.000 kroner til 915.000 kroner. For spesielt kvalifiserte kandidater kan høyere lønn vurderes.',
		...
		image_link:
			'https://www.mycarpentry.com/image-files/xdeck-stair-house-perspective.jpg.pagespeed.ic.r3NyM_JrfO.webp',
